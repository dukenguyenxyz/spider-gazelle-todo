...
module App
  ...
  POSTGRES_URI_DEV  = ENV["POSTGRES_URI"]? || "postgresql://postgres:password@localhost:5432/crystal_to_do_dev"
  POSTGRES_URI_TEST = "postgresql://postgres:password@0.0.0.0:5432/crystal_to_do_test"
