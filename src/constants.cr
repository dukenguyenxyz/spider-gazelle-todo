...
module App
  ...
  POSTGRES_URI_DEV  = ENV["POSTGRES_URI"]? || "postgresql://postgres:password@db:5432/crystal_to_do_prod"
  POSTGRES_URI_TEST = "postgresql://postgres:password@db:5432/crystal_to_do_test"
